    ...
    <div className="cal-wrapper">
      ...
      <div className="cal-body">
        <div className="cal-nav-row">
          <button className="cal-nav" onClick={() => setView(new Date(year, month - 1, 1))}>
            ‹
          </button>
        ...
        <div className="cal-grid">
          {WEEKDAYS.map((d, i) => (
            <div key={d} className={`cal-wday${i === 0 || i === 6 ? ' cal-wend-h' : ''}`}>
              {d}
            </div>
          ))}
          {cells.map((d, i) => {
      ...
      <div className="w-header">
        <div className="w-loc">
          <svg width="11" height="13" viewBox="0 0 11 13">
            <path
              d="M5.5 0A4.5 4.5 0 001 4.5C1 7.94 5.5 13 5.5 13S10 7.94 10 4.5A4.5 4.5 0 005.5 0zm0 6a1.5 1.5 0 110-3 1.5 1.5 0 010 3z"
