...
import ExamAccessModal from '../../exam-access/components/ExamAccessModal';
...
export default function StudentExamList() {
  ...
  function handlePwSuccess() {
    navigate(`/student/exams/${pwModal.examId}/take`);
  ...
  return (
    <div className="stu-exams">
      ...
      {pwModal.open && (
        <ExamAccessModal
          examId={pwModal.examId}
          title={pwModal.title}
          onClose={() => setPwModal({ open: false, examId: '', title: '' })}
