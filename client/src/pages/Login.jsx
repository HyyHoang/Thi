...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // API backend nhận { username, password } và trả về
      ...
      const apiMessage = err.response?.data?.errors?.username?.[0] || err.response?.data?.message || err.message;
      ...
      <div className="al-root">
        ...
        <div className="al-card">
          ...
          <div className="al-title-row">
            ...
            <p className="al-subtitle">Nhập thông tin tài khoản quản trị của bạn</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="al-field">
              ...
              {errors.username && (
                <div className="al-field-err">
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="#E53E3E"><circle cx="12" cy="12" r="10" /><path fill="white" d="M11 8h2v5h-2zm0 7h2v2h-2z" /></svg>
                  {errors.username}
                </div>
              )}
            </div>
            ...
            <div className="al-options">
              ...
              <button type="button" className="al-forgot">Quên mật khẩu?</button>
            </div>
